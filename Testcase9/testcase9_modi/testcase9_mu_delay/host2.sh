...
ifconfig host2-eth1 10.0.3.1 netmask 255.255.255.255
ip rule add from 10.0.3.1 table 2
ip route add 10.0.3.1/32 dev host2-eth1 scope link table 2
ip route add default via 10.0.3.1 dev host2-eth1 table 2
