...
sudo ovs-ofctl add-flow s1 ip,nw_src=10.0.2.0/32,actions=set_queue:2,output:5
...
sudo ovs-ofctl add-flow s3 ip,nw_src=10.0.5.0/32,actions=set_queue:7,output:3
...
sudo ovs-ofctl add-flow s4 ip,nw_src=10.0.7.0/32,actions=set_queue:9,output:5
...
sudo ovs-ofctl add-flow s5 ip,nw_src=10.0.10.0/32,actions=set_queue:13,output:5
