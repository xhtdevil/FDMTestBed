...
sudo ovs-ofctl add-flow s15 ip,nw_src=10.0.13.1/32,actions=output:3
sudo ovs-ofctl add-flow s15 ip,nw_src=10.0.4.0/32,actions=output:3
sudo ovs-ofctl add-flow s15 in_port=3,actions=normal
sudo ovs-ofctl add-flow s16 ip,nw_src=10.0.10.0/32,actions=output:3
sudo ovs-ofctl add-flow s16 ip,nw_src=10.0.7.0/32,actions=output:3
sudo ovs-ofctl add-flow s16 in_port=3,actions=normal
sudo ovs-ofctl add-flow s17 ip,nw_src=10.0.11.1/32,actions=output:2
sudo ovs-ofctl add-flow s17 ip,nw_src=10.0.5.1/32,actions=output:2
sudo ovs-ofctl add-flow s17 in_port=2,actions=normal
sudo ovs-ofctl add-flow s18 ip,nw_src=10.0.8.0/32,actions=output:3
sudo ovs-ofctl add-flow s18 ip,nw_src=10.0.14.0/32,actions=output:3
sudo ovs-ofctl add-flow s18 ip,nw_src=10.0.1.0/32,actions=output:3
sudo ovs-ofctl add-flow s18 in_port=3,actions=normal
sudo ovs-ofctl add-flow s19 ip,nw_src=10.0.2.1/32,actions=output:3
