...
ifconfig host3-eth1 10.0.4.1 netmask 255.255.255.255
ip rule add from 10.0.4.1 table 2
ip route add 10.0.4.1/32 dev host3-eth1 scope link table 2
ip route add default via 10.0.4.1 dev host3-eth1 table 2
