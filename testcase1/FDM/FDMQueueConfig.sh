...
sudo ifconfig s1-eth3 txqueuelen 0
...
sudo ifconfig s1-eth4 txqueuelen 0
...
sudo ifconfig s2-eth3 txqueuelen 0
...
sudo ifconfig s2-eth4 txqueuelen 0
...
sudo ifconfig s3-eth2 txqueuelen 0
...
sudo ifconfig s4-eth3 txqueuelen 0
...
sudo ifconfig s4-eth4 txqueuelen 0
...
sudo ifconfig s5-eth3 txqueuelen 0
...
sudo ifconfig s5-eth4 txqueuelen 0
