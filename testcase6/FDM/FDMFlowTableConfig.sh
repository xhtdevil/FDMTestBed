...
sudo ovs-ofctl add-flow s1 ip,nw_src=10.0.2.0/32,actions=set_queue:1,output:5
sudo ovs-ofctl add-flow s1 ip,nw_src=10.0.1.0/32,actions=set_queue:2,output:5
sudo ovs-ofctl add-flow s1 in_port=5,actions=normal
sudo ovs-ofctl add-flow s1 ip,nw_src=10.0.2.1/32,actions=set_queue:3,output:6
sudo ovs-ofctl add-flow s1 in_port=6,actions=normal
sudo ovs-ofctl add-flow s2 ip,nw_src=10.0.4.0/32,actions=set_queue:4,output:5
sudo ovs-ofctl add-flow s2 in_port=5,actions=normal
sudo ovs-ofctl add-flow s2 ip,nw_src=10.0.5.1/32,actions=set_queue:5,output:6
sudo ovs-ofctl add-flow s2 in_port=6,actions=normal
sudo ovs-ofctl add-flow s3 ip,nw_src=10.0.8.0/32,actions=set_queue:6,output:3
sudo ovs-ofctl add-flow s3 ip,nw_src=10.0.7.0/32,actions=set_queue:7,output:3
sudo ovs-ofctl add-flow s3 in_port=3,actions=normal
sudo ovs-ofctl add-flow s4 ip,nw_src=10.0.10.0/32,actions=set_queue:8,output:5
sudo ovs-ofctl add-flow s4 in_port=5,actions=normal
sudo ovs-ofctl add-flow s4 ip,nw_src=10.0.10.1/32,actions=set_queue:9,output:6
sudo ovs-ofctl add-flow s4 ip,nw_src=10.0.11.1/32,actions=set_queue:10,output:6
sudo ovs-ofctl add-flow s4 in_port=6,actions=normal
sudo ovs-ofctl add-flow s5 ip,nw_src=10.0.14.0/32,actions=set_queue:11,output:5
sudo ovs-ofctl add-flow s5 ip,nw_src=10.0.13.0/32,actions=set_queue:12,output:5
sudo ovs-ofctl add-flow s5 in_port=5,actions=normal
sudo ovs-ofctl add-flow s5 ip,nw_src=10.0.13.1/32,actions=set_queue:13,output:6
...
sudo ovs-ofctl add-flow s12 ip,nw_src=10.0.13.0/32,actions=output:2
...
sudo ovs-ofctl add-flow s12 ip,nw_src=10.0.2.0/32,actions=output:5
sudo ovs-ofctl add-flow s12 in_port=5,actions=normal
sudo ovs-ofctl add-flow s13 ip,nw_src=10.0.10.1/32,actions=output:2
