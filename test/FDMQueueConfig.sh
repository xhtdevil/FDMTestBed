...
sudo ovs-vsctl -- set Port s1-eth7 qos=@newqos -- --id=@newqos create QoS type=linux-htb other-config:max-rate=100000000 queues:1=@q1 -- --id=@q1 create Queue other-config:min-rate=3102310 other-config:max-rate=3102310
sudo ovs-vsctl -- set Port s1-eth7 qos=@newqos -- --id=@newqos create QoS type=linux-htb other-config:max-rate=100000000 queues:2=@q2 -- --id=@q2 create Queue other-config:min-rate=4618000 other-config:max-rate=4618000
...
sudo ovs-vsctl -- set Port s2-eth8 qos=@newqos -- --id=@newqos create QoS type=linux-htb other-config:max-rate=100000000 queues:7=@q7 -- --id=@q7 create Queue other-config:min-rate=278798 other-config:max-rate=278798
sudo ovs-vsctl -- set Port s2-eth8 qos=@newqos -- --id=@newqos create QoS type=linux-htb other-config:max-rate=100000000 queues:8=@q8 -- --id=@q8 create Queue other-config:min-rate=2416220 other-config:max-rate=2416220
...
sudo ovs-vsctl -- set Port s4-eth8 qos=@newqos -- --id=@newqos create QoS type=linux-htb other-config:max-rate=100000000 queues:16=@q16 -- --id=@q16 create Queue other-config:min-rate=119485 other-config:max-rate=119485
sudo ovs-vsctl -- set Port s4-eth8 qos=@newqos -- --id=@newqos create QoS type=linux-htb other-config:max-rate=100000000 queues:17=@q17 -- --id=@q17 create Queue other-config:min-rate=2416220 other-config:max-rate=2416220
