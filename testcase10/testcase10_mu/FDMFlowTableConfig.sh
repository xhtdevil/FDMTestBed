...
sudo ovs-ofctl add-flow s2 ip,nw_src=10.0.3.0/32,actions=set_queue:4,output:5
sudo ovs-ofctl add-flow s2 in_port=5,actions=normal
sudo ovs-ofctl add-flow s2 ip,nw_src=10.0.4.1/32,actions=set_queue:5,output:6
